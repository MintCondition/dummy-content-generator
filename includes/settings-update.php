...
function dcg_display_update_info() {
    ...
    <p><?php esc_html_e('Latest Version: ', 'text-domain'); ?><strong><?php echo esc_html($latest_version); ?></strong></p>
    <p><?php esc_html_e('Last Update Check: ', 'text-domain'); ?><strong><?php echo esc_html($last_update_check); ?></strong></p>
